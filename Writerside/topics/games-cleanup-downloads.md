...
<step>Regular maintenance to manage storage space</step>
<step>Before storage capacity reaches limits</step>
<step>After bulk game imports or updates</step>
<step>When preparing for system backups</step>
<step>During server maintenance windows</step>
</procedure>
