...
class SystemStatus extends Component
{
    ...
    public function render()
    {
        ...
        $this->monitoredTasks = MonitoredScheduledTask::query()
        ...
        $this->healthSummary = [
            'total' => $this->monitoredTasks->count(),
            'active' => $this->monitoredTasks->filter(function ($task) {
            ...
            'failed' => $this->monitoredTasks->filter(function ($task) {
                if (! $task['last_failed']) {
                    return false;
                }
