        ...
        <div class="space-y-2 text-sm text-gray-600 dark:text-gray-400">
          {#if insights}
            ...
            {#if insights.avgDailyViews > 0}
              <div>
                &#8226; Averaging <strong>{Math.round(insights.avgDailyViews * 10) / 10}</strong> unique views per day this
                week
              </div>
            {/if}
            ...
            {/if}
            <div
              class="mt-3 border-t border-gray-200 pt-2 text-xs text-gray-600 dark:border-gray-700 dark:text-gray-400"
            >
