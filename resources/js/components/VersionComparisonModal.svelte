                ...
                <div>
                    ...
                    <div class="mt-1 flex items-center gap-2">
                        <div class="font-medium text-gray-100">
                            ...
                            <span class="text-sm text-gray-400">({formatLocalDate(comparisonData.fromVersion.published_at)})</span>
                        </div>
                        <ArrowRightIcon class="h-4 w-4 text-gray-400" />
                        <div class="font-medium text-gray-100">
                            Version {comparisonData.toVersion.version}
                            <span class="text-sm text-gray-400">({formatLocalDate(comparisonData.toVersion.published_at)})</span>
                        </div>
                    </div>
                </div>
            </div>
