...
export default function Navigation() {
    ...
    const navLinkBase = "relative rounded-full px-3.5 py-2 text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[var(--color-brand-secondary)] focus:ring-offset-2";
    const navLinkInactive = "text-[var(--color-ui-text-muted)] hover:bg-[var(--color-ui-surface-alt)] hover:text-[var(--color-ui-text)]";
    const navLinkActive = "bg-[var(--color-surface-peach)] text-[var(--color-link-hover)] shadow-sm";
