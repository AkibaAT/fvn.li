...
<div class="flex items-center gap-3">
    ...
    <div class="inline-flex rounded-md shadow-sm" role="group" aria-label="Sort direction">
        <button
            ...
            class="cursor-pointer rounded-l-md border border-gray-300 px-3 py-1 text-sm dark:border-gray-600 {currentDirection === 'desc'
        ...
        <button
            ...
            class="-ml-px cursor-pointer rounded-r-md border-t border-r border-b border-gray-300 px-3 py-1 text-sm dark:border-gray-600 {currentDirection ===
            'asc'
                ? 'bg-gray-100 text-gray-900 dark:bg-gray-600 dark:text-white'
                : 'bg-white text-gray-700 dark:bg-gray-700 dark:text-gray-200'}"
        >
