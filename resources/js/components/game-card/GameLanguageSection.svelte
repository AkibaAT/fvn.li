...
{#if languages && languages.length > 0}
    <div class="h-auto border-t border-gray-100 pt-2 dark:border-gray-700/50">
        <div class="flex items-center gap-1">
            ...
            {#if totalHiddenLanguageCount > 0 || languagesExpanded}
                <button
                    ...
                    title={languagesExpanded ? 'Show less' : `Show ${totalHiddenLanguageCount} more languages`}
                    aria-label={languagesExpanded ? 'Show less' : `Show ${totalHiddenLanguageCount} more languages`}
                >
                    <svg
