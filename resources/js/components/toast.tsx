...
// Hook for components to subscribe to notifications
export function useNotifications() {
    ...
    return {
        notifications,
        closeNotification: notificationManager.remove.bind(notificationManager),
    };
}

// Global function for showing notifications (no re-renders)
    ...
    return (
        <div className="fixed right-4 bottom-4 z-50 space-y-2">
            {notifications.map((notification) => (
                <div
                    key={notification.id}
                    className={`ring-opacity-5 pointer-events-auto w-96 max-w-sm overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 ${getNotificationClasses(notification.type)}`}
                    role="alert"
                        ...
                        <div className="flex items-start">
                            ...
                            <div className="ml-4 flex flex-shrink-0">
                                <button
                                    ...
                                    className="inline-flex rounded-md bg-white text-gray-400 hover:text-gray-500 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none dark:bg-gray-800"
