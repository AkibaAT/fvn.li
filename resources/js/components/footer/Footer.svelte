        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="lg:col-span-1">
                <div class="mb-4 flex items-center space-x-3">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-blue-600 dark:text-blue-400">FVN.li</h2>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="space-y-3 text-sm text-gray-500 dark:text-zinc-400">
                    <p>
                        Add the following link to your bookmarks to quickly access ratings from any itch.io project page, including those not listed
                        on FVN.li:
                    </p>
                    <a
