...
>
    ...
    {:else}
        <div class="space-y-3 py-4">
            <a href={route('auth.redirect', 'discord')} class="flex w-full items-center rounded-lg border border-gray-300 px-4 py-2 text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">
                <i class="icon-discord mr-3 h-5 w-5 text-indigo-500"></i>
                <span>Discord</span>
            </a>
            <a href={route('auth.redirect', 'google')} class="flex w-full items-center rounded-lg border border-gray-300 px-4 py-2 text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">
            ...
            <a href={route('auth.redirect', 'itchio')} class="flex w-full items-center rounded-lg border border-gray-300 px-4 py-2 text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">
                <Itchio class="mr-3 h-5 w-5 text-itchio" />
                <span>itch.io</span>
            </a>
            <a href={route('auth.redirect', 'steam')} class="flex w-full items-center rounded-lg border border-gray-300 px-4 py-2 text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">
                <Steam class="mr-3 h-5 w-5" />
                <span>Steam</span>
            </a>
            <a href={route('auth.redirect', 'telegram')} class="flex w-full items-center rounded-lg border border-gray-300 px-4 py-2 text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">
