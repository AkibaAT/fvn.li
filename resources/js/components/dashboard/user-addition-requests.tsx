...
export function UserAdditionRequests() {
    ...
    const fetchRequests = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(
                route('react-api.dashboard.addition-requests.index') +
                `?${params}`,
            );
    ...
    useEffect(() => {
        fetchRequests();
    }, [statusFilter, search, page, fetchRequests]);
    ...
    useEffect(() => {
        ...
        window.addEventListener('addition-requests-updated', handleUpdate);
        return () =>
            window.removeEventListener(
                'addition-requests-updated',
                handleUpdate,
            );
    }, [statusFilter, search, page, fetchRequests]);
                                ...
                                <div className="flex items-start justify-between">
                                    ...
                                    {request.status === 'pending' && (
                                        <button
                                            ...
                                            className="ml-3 text-sm text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300"
                                        >
                                            Cancel
                                        </button>
                                    )}
