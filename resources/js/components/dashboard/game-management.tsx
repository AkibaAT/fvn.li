...
export function GameManagement(): JSX.Element {
    ...
    useEffect(() => {
        // Fetch game management stats
        fetch(route('react-api.dashboard.game-stats'))
        ...
        <div
            ...
            <div className="p-6">
                ...
                <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
                    Manage your games published on itch.io. Add additional
                    download links and update game information.
                </p>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-sm font-medium text-blue-800 dark:text-blue-300">
                                            Connected:{' '}
                                            {gameStats.itchioUsername}.itch.io
                                        </div>
                                        <div className="text-xs text-blue-600 dark:text-blue-400">
                                            {gameStats.ownedGamesCount}{' '}
                                            {gameStats.ownedGamesCount === 1
                                                ? 'game'
                                                : 'games'}{' '}
                                            found
                                            {gameStats.gamesWithLinksCount >
                                                0 && (
                                                    <>
                                                        {' '}
                                                        •{' '}
                            ...
                            <div
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="text-sm text-yellow-800 dark:text-yellow-300">
                                        Connect your itch.io account to manage
                                        your games
                                    </div>
                                </div>
                            </div>
