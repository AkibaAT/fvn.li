...
export default function DialogueBrowser({ initial }: InitialProps) {
    ...
    const searchResults: DialogueSearchResult[] = searchData?.results || [];
    ...
    const loading = optionsLoading || searchLoading || duplicatesLoading;
    const canSearch = !!versionId;
        ...
        <>
            <div className="bg-gray-100 dark:bg-gray-900">
                <div className="mx-auto max-w-7xl">
                    <div className="sticky top-0 z-10 mb-4 flex items-center justify-between bg-gray-100 py-4 dark:bg-gray-900">
                        <Link
