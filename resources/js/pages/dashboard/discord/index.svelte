...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Discord Servers</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage Discord server configurations for game notifications</p>
        </div>
        <Link
    ...
    {:else if guilds.length === 0}
        <div class="rounded-xl border border-gray-200/50 bg-white/70 p-12 text-center backdrop-blur-xl dark:border-gray-700/50 dark:bg-gray-800/70">
            ...
            <h3 class="mt-4 text-lg font-semibold text-gray-900 dark:text-white">No servers found</h3>
