            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                ...
                <dl class="grid grid-cols-2 gap-4">
                    @foreach([
                        ...
                        'Latest Update' => $game->version_published_at?->format('M j, Y'),
                        'Current Version' => $game->version,
                        'Word Count' => number_format($game->stats_words),
                        'Block Count' => number_format($game->stats_blocks),
                        'Menu Count' => number_format($game->stats_menus),
                        'Option Count' => number_format($game->stats_options),
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        @foreach($versions as $version)
                            <tr class="text-sm text-gray-900 dark:text-gray-100">
                                ...
                                <td class="px-4 py-2">{{ number_format($version->stats_words) }}</td>
