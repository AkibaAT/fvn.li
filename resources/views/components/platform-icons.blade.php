...
<div class="flex space-x-1 text-lg">
    @if($platforms['windows'] ?? false)
        <button
            ...
            @class([
                'px-1',
                'bg-blue-200 dark:bg-blue-800 shadow-sm' => in_array('windows', $selectedPlatforms ?? []),
            ])>
    ...
    @if($platforms['linux'] ?? false)
        <button
            ...
            @class([
                'px-1',
                'bg-blue-200 dark:bg-blue-800 shadow-sm' => in_array('linux', $selectedPlatforms ?? []),
            ])>
    ...
    @if($platforms['mac'] ?? false)
        <button
            ...
            @class([
                'px-1',
                'bg-blue-200 dark:bg-blue-800 shadow-sm' => in_array('mac', $selectedPlatforms ?? []),
            ])>
    ...
    @if($platforms['android'] ?? false)
        <button
            ...
            @class([
                'px-1',
                'bg-blue-200 dark:bg-blue-800 shadow-sm' => in_array('android', $selectedPlatforms ?? []),
            ])>
    ...
    @if($platforms['web'] ?? false)
        <button
            ...
            @class([
                'px-1',
                'bg-blue-200 dark:bg-blue-800 shadow-sm' => in_array('web', $selectedPlatforms ?? []),
            ])>
