@if (!empty($selectedPlatforms) || !empty($selectedStatuses) || !empty($selectedEngines) || !empty($selectedLanguages) || !empty($selectedGameJams) || $nsfw || $sfw || ($sortField !== 'latest_version_published_at' || $sortDirection !== 'desc') || $showHidden)
    <div class="mb-4">
