@if (!empty($selectedPlatforms) || !empty($selectedStatuses) || !empty($selectedEngines) || !empty($selectedLanguages) || !empty($selectedGameJams) || $nsfw || $sfw || $showPaid || $showFree || $showDemo || ($sortField !== 'latest_version_published_at' || $sortDirection !== 'desc') || $showHidden)
    <div class="mb-4">
