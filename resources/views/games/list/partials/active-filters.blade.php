@if (!empty($selectedPlatforms) || !empty($selectedStatuses) || !empty($selectedEngines) || !empty($selectedLanguages) || $nsfw || $sfw || ($sortField !== 'latest_version_published_at' || $sortDirection !== 'desc') || $showHidden)
    <div class="mb-4">
