...
- **[meilisearch:setup](setup.md)**: Set up Meilisearch indexes and migrate data from PostgreSQL search
- **[meilisearch:reindex](reindex.md)**: Reindex content in Meilisearch for maintenance (normal operations use automatic indexing)
- **[scout:sync-index-settings](sync-index-settings.md)**: Sync your configured index settings with your search engine
